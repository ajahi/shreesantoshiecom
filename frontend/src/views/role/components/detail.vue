        ...
        <div class="createPost-main-container">
            ...
            >
                ...
                <el-col :span="24">
                    ...
                    <el-form-item label="Permissions" prop="permission_list">
                        <el-select v-model="temp.permission_list" multiple placeholder="Select Permission">
                            <el-option
...
<script>
    ...
    export default {
        ...
        created() {
            this.$axios.get('/permission').then(response => {
        ...
        methods: {
            fetchData(id) {
                this.$axios.get('/role/' + id).then(response => {
                ...
                this.$refs['dataForm'].validate((valid) => {
                    ...
                    if (valid) {
                        ...
                        if (!this.isEdit) {
                            ...
                            this.$axios.post('/role/' + this.temp.id, this.temp).then(response => {
                                this.$message({
                                    type: 'success',

    ...
    <div class="app-container">
        ...
        <el-table
            ...
            <el-table-column align="center" label="Action" width="250" class-name="small-padding fixed-width">
                <template slot-scope="scope">
                    <router-link :to="'/permission/edit/'+scope.row.id">
    ...
    export default {
        ...
        methods: {
            getList() {
                ...
                this.$axios.get('/permission', {params: this.listQuery}).then(response => {
            ...
            handleDelete(row) {
                this.$confirm('This will permanently delete. Continue?', 'Warning', {
                    ...
                    this.$axios.delete('/permission/' + row.id).then(response => {
